...
const NavBar = () => {
    ...
    return (
        <nav className="fixed top-0 right-0 w-full flex justify-between user-select-none px-10 mt-8 items-center">
            <div>
            ...
            <div  className="md:hidden" onClick={togglePopup}>
            ...
            {menuIsOpen && (
                <div className="fixed top-0 left-0 right-0 bottom-0 w-full bg-black flex items-center justify-center">
                    <div className="fixed top-8 right-10 flex items-center space-x-4">
                        <div onClick={togglePopup}>
                            <svg width="19" height="19" viewBox="0 0 19 19" className="text-white">
                                <path fill="currentColor" d="M1 17L17 1l1.5 1.5L2.5 18.5z"></path>
                                <path fill="currentColor" d="M1.5 0l16.5 16.5-1.5 1.5L0 1.5z"></path>
                            </svg>
                        </div>
                    </div>
                    <div className={`flex flex-col items-center text-white text-2xl text-menu`}>
                        <p className="mb-5">Filter</p>
                        <a className="mb-5 hover:underline" href="/about">About</a>
                        <a className="mb-5 hover:underline" href="/login">Login</a>
                    </div>
                </div>
            )}
        </nav>
